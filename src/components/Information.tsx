  ...
  return (
    <div className="mt-32 px-4 sm:mt-24 lg:px-24 w-full">
      ...
      <p className="md:w-[90%] py-2 sm:text-lg">
        ...
        consectetur adipisicing elit. Corrupti accusantium optio dolor laborum,
        reiciendis voluptatibus eaes Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Magni, ut.
      </p>

      <p className="md:w-[70%] py-2 sm:text-lg">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint magnam
        fugiat nobis odit repellat necessitatibus. Lorem ipsum dolor, sit amet
        consectetur adipisicing elit. Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Ipsam odit eum vitae modi
      </p>
    </div>
  );
};
